...
class AtividadesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create atividade" do
    assert_difference('Atividade.count') do
      post atividades_url, params: { atividade: { batismo: @atividade.batismo, casado_a: @atividade.casado_a, ccc: @atividade.ccc, ctl: @atividade.ctl, dizimista: @atividade.dizimista, encontro: @atividade.encontro, id_atividade: @atividade.id_atividade } }
    end
  ...
  test "should update atividade" do
    patch atividade_url(@atividade), params: { atividade: { batismo: @atividade.batismo, casado_a: @atividade.casado_a, ccc: @atividade.ccc, ctl: @atividade.ctl, dizimista: @atividade.dizimista, encontro: @atividade.encontro, id_atividade: @atividade.id_atividade } }
